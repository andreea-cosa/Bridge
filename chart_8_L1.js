const htmlLegendPlugin_chart_8_L1 = {
  id: "chart_8_L1_legends",
  afterUpdate(chart, args, options) {
    const ul = getOrCreateLegendList(chart, "chart_8_L1_legends");
...
function drawChart8(data) {
  ...
  var myChart8 = new Chart(ctx8, {
      ...
      plugins: {
        ...
        tooltip: {
          ...
          external: function (context) {
            externalTooltipHandler(context, total8);
          },
        },
        legend: {
          display: false,
    ...
    plugins: [htmlLegendPlugin_chart_8_L1],
  });
  return myChart8;
}
