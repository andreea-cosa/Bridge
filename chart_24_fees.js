const htmlLegendPlugin_chart_24_fees = {
  id: "chart_24_fees_legends",
  afterUpdate(chart, args, options) {
    const ul = getOrCreateLegendList(chart, "chart_24_fees_legends");
...
function drawChart24(data) {
  ...
  var myChart24 = new Chart(ctx24, {
      ...
      plugins: {
        ...
        tooltip: {
          ...
          external: function (context) {
            externalTooltipHandler(context, total24);
          },
        },
        legend: {
          display: false,
    ...
    plugins: [htmlLegendPlugin_chart_24_fees],
  });
  return myChart24;
}
