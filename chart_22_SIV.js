const htmlLegendPlugin_chart_22_SIV = {
  id: "chart_22_SIV_legends",
  afterUpdate(chart, args, options) {
    const ul = getOrCreateLegendList(chart, "chart_22_SIV_legends");
...
function drawChart22(data) {
  ...
  var myChart22 = new Chart(ctx22, {
      ...
      plugins: {
        ...
        tooltip: {
          ...
          external: function (context) {
            externalTooltipHandler(context, total22);
          },
        },
        legend: {
          display: false,
    ...
    plugins: [htmlLegendPlugin_chart_22_SIV],
  });
  return myChart22;
}
