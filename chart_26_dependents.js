const htmlLegendPlugin_chart_26_dependents = {
  id: "chart_26_dependents_legends",
  afterUpdate(chart, args, options) {
    const ul = getOrCreateLegendList(chart, "chart_26_dependents_legends");
...
function drawChart26(data) {
  ...
  var myChart26 = new Chart(ctx26, {
      ...
      plugins: {
        ...
        tooltip: {
          ...
          external: function (context) {
            externalTooltipHandler(context, total26);
          },
        },
        legend: {
          display: false,
    ...
    plugins: [htmlLegendPlugin_chart_26_dependents],
  });
  return myChart26;
}
