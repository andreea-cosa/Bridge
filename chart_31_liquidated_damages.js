const htmlLegendPlugin_chart_31_liquidated_damages = {
  id: "chart_31_liquidated_damages_legends",
  afterUpdate(chart, args, options) {
    const ul = getOrCreateLegendList(
      chart,
      "chart_31_liquidated_damages_legends"
    );
...
function drawChart31(data) {
  ...
  var myChart31 = new Chart(ctx31, {
    ...
    plugins: [htmlLegendPlugin_chart_31_liquidated_damages],
  });
  return myChart31;
}
